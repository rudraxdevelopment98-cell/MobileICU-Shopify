...
//   document.querySelectorAll('.quick-add-bulk').forEach(function (container) {
//     const minusBtn = container.querySelector('.minus');
//     const plusBtn = container.querySelector('.plus');
//     const qtyInput = container.querySelector('.qty-input');
//     const addToCartBtn = container.querySelector('.quick-add__submit');
...
//           document.querySelectorAll('.cart-count, .cart-count-bubble span').forEach(el => {
...
//                   // currentDrawer.classList.add('animate', 'active');
//                 }
//               });
...
//                 // Optional: Trigger open and animation
//                 // currentDrawer.setAttribute('open', '');
//                 // currentDrawer.classList.add('animate', 'active');
//               }
//             });
